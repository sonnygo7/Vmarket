...
select * from member where m_email='ljpson@naver.com';
select * from member where m_email='undefined';
delete from member where m_email='ljpson@naver.com';
delete from member where m_email='undefined'
delete from delivery where m_email='undefined'
select * from qna where m_email='undefined';
select s_profile,s_myself from shop;
select * from shop where s_email= 'admin@naver.com' and( s_status='2' or s_status='m')
